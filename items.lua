itemList = {
    {"Bud light", "minecraft:potion", 5, false, "1"}, --Name in search, item name to pull from storage, unit cost, can edit quanity---min and max at end if quanity can be editited (true)-- (Max must be greater than min and the same length or more. Both must be greater than 1)
